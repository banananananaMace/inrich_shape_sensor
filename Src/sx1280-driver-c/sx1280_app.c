...
//        AppState=10;
//        // printf("发送REQ帧\r\n");
//	    //	SendtoStation_sx1280_frame(REQ,2,0,0);
//        Radio.SetDioIrqParams( RxIrqMask, RxIrqMask, IRQ_RADIO_NONE, IRQ_RADIO_NONE);
//        Radio.SetRx(TTtime_RX);//设置为接收模式
//        break;
//    default:
...
//	  Radio.SendPayload( SndBuffer,send_length,TTtime_TX);
//	return 0;
//}
...
//0
//void SX1280_SendData(void)
//{
//		int i;
//		Buffer[11] = 0;
//	  for (i=0;i<11;i++)Buffer[11] += Buffer[i];
//	  Radio.SetDioIrqParams( TxIrqMask, TxIrqMask, IRQ_RADIO_NONE, IRQ_RADIO_NONE);
